...
| `node:crypto` | Hashing, UUIDs, random bytes, encryption | [04-authentication/02](../04-authentication/02-password-hashing.md) |
...
| `node:test`, `node:assert` | Built-in test runner | [05-testing/01](../05-testing/01-testing-basics.md) |
| `node:child_process` | Spawn processes | [07-deployment/01](../07-deployment/01-production-basics.md) |
