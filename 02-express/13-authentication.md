...
> [04-authentication/02-password-hashing.md](../04-authentication/02-password-hashing.md), tokens in
> [03-jwt.md](../04-authentication/03-jwt.md) and [04-access-refresh-tokens.md](../04-authentication/04-access-refresh-tokens.md),
> OAuth in [05-oauth.md](../04-authentication/05-oauth.md), and roles in
> [06-role-based-access.md](../04-authentication/06-role-based-access.md).
